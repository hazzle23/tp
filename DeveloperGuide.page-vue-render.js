...
with(this){return _c('ol',[_c('li',[_v("Make each applicant to have a unique ID: The current addressbook list shows the numbering of each contact based on its sequence. We plan to generate a random unique ID for each applicant (Eg.JXZ1000).")])])}
},function anonymous(
) {
...
with(this){return _c('footer',[_c('div',{staticClass:"text-center"},[_c('small',[_v("["),_c('span',[_c('strong',[_v("Powered by")])]),_v(" "),_c('img',{attrs:{"src":"https://markbind.org/favicon.ico","width":"30"}}),_v(" "),_c('a',{attrs:{"href":"https://markbind.org/"}},[_v("MarkBind 5.5.3")]),_v(", generated on Tue, 12 Nov 2024, 2:32:20 GMT+8]")])])])}
}];
