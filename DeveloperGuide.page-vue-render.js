...
with(this){return _c('h3',{attrs:{"id":"mass-reject-feature"}},[_v("Mass Reject feature"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#mass-reject-feature","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
...
with(this){return _c('h3',{attrs:{"id":"statistics-feature"}},[_v("Statistics feature"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#statistics-feature","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
with(this){return _c('p',[_v("Like "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("ListCommand")]),_v(", it does not require the use of its own parser, as it only calls upon the FilteredList of the\naddress book and processes it within the statistics feature.\nIt uses a helper class called JobCodeStatistics that stores the number of applicants in each interview stage for that\njob code.")])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_c('p',[_c('strong',[_v("Enhanced Find Command with Multiple Keywords")]),_c('br'),_v("\nThe current "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("find")]),_v(" command supports only one keyword at a time for each field. We plan to extend this functionality to accept multiple keywords (e.g., "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("find n/Hans or n/Hera")]),_v("), making it easier for users to locate multiple contacts in a single search.")])]),_v(" "),_c('li',[_c('p',[_c('strong',[_v("Extended Tagging Functionality")]),_c('br'),_v("\nPresently, only a limited set of tags is supported. We plan to expand this feature to support additional types of tags, enabling more flexible categorization and better organization of contacts.")])]),_v(" "),_c('li',[_c('p',[_c('strong',[_v("Resizable Feedback Box")]),_c('br'),_v("\nUsers are currently unable to adjust the feedback box size. To improve usability, we plan to make the feedback box resizable, allowing users to expand or contract it based on their preferences and screen size.")])]),_v(" "),_c('li',[_c('p',[_c('strong',[_v("Restrictive Phone Number Validation")]),_c('br'),_v("\nThe existing phone number validation allows entries as short as three digits. We plan to tighten validation criteria to ensure that phone numbers meet a more realistic length requirement, improving data accuracy and reliability.")])]),_v(" "),_c('li',[_c('p',[_c('strong',[_v("Appendable Remarks")]),_c('br'),_v("\nCurrently, remarks can only be overwritten, not appended to. We plan to enhance the remark feature to support appending, so users can add additional notes without replacing existing remarks.")])]),_v(" "),_c('li',[_c('p',[_c('strong',[_v("Advanced Statistics Filtering Options")]),_c('br'),_v("\nTo support more detailed insights, we plan to extend statistics functionality by offering additional predicate filters. This enhancement will allow users to specify criteria (e.g., "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Stats [j/] [t/]")]),_v(") for more targeted statistical analysis.")])]),_v(" "),_c('li',[_c('p',[_c('strong',[_v("Mass Actions Command")]),_c('br'),_v("\nAt present, the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("massReject")]),_v(" command allows only batch rejections. We plan to rename this command to "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("mass")]),_v(" and introduce a predicate/parameter option to enable mass deletions, edits, or rejections. This will streamline bulk actions, making management of large applicant pools more efficient.")])]),_v(" "),_c('li',[_c('p',[_c('strong',[_v("Unique Listing with Job Predicate")]),_c('br'),_v("\nThe "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("list")]),_v(" command currently lacks options for filtering by unique attributes. We plan to enhance it by adding the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("list [j/]")]),_v(" parameter to allow listing of unique items, such as distinct jobs or tags, providing users with a clearer overview.")])])])}
},function anonymous(
) {
...
with(this){return _c('ul',[_c('li',[_v("employees of a company's talent recruitment departments who need to manage contacts of job applicants.")]),_v(" "),_c('li',[_v("prefer desktop apps over other types")]),_v(" "),_c('li',[_v("can type fast")]),_v(" "),_c('li',[_v("prefers typing to mouse interactions")]),_v(" "),_c('li',[_v("is reasonably comfortable using CLI apps")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Value proposition")]),_v(": This app streamlines the process of managing talent contact information by centralizing essential\ncontact details, making it easier to organise, search, and update information on potential candidates.\nIts search and filtering capabilities help recruiters quickly find profiles based on specific criteria,\nimproving efficiency and reducing time spent on administrative tasks.")])}
},function anonymous(
) {
...
with(this){return _c('div',{staticClass:"table-responsive"},[_c('table',{staticClass:"markbind-table table table-bordered table-striped"},[_c('thead',[_c('tr',[_c('th',[_v("Priority")]),_v(" "),_c('th',[_v("As a …​")]),_v(" "),_c('th',[_v("I want to …​")]),_v(" "),_c('th',[_v("So that I can…​")])])]),_v(" "),_c('tbody',[_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * *")])]),_v(" "),_c('td',[_v("user")]),_v(" "),_c('td',[_v("see the list of all contacts")]),_v(" "),_c('td',[_v("see the contact details of every applicants")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * *")])]),_v(" "),_c('td',[_v("user")]),_v(" "),_c('td',[_v("add a new contact")]),_v(" "),_c('td',[_v("keep track of applicant's contact details")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * *")])]),_v(" "),_c('td',[_v("user")]),_v(" "),_c('td',[_v("delete a contact")]),_v(" "),_c('td',[_v("remove contact of applicants who is no longer in the recruitment process")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * *")])]),_v(" "),_c('td',[_v("user")]),_v(" "),_c('td',[_v("find a contact by his/her name")]),_v(" "),_c('td',[_v("see particular applicant's contact detail without having to go through the entire list")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* * *")])]),_v(" "),_c('td',[_v("user")]),_v(" "),_c('td',[_v("tag applicants based on their stage in the recruitment process")]),_v(" "),_c('td',[_v("track their progress and determine the next steps in the recruitment process.")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* *")])]),_v(" "),_c('td',[_v("efficient user")]),_v(" "),_c('td',[_v("filter contacts which fulfil several criteria")]),_v(" "),_c('td',[_v("quickly access the list of contacts that matches my needs")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* *")])]),_v(" "),_c('td',[_v("user")]),_v(" "),_c('td',[_v("sort the contacts based on certain criteria")]),_v(" "),_c('td',[_v("quickly access the contacts that I need to prioritize")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* *")])]),_v(" "),_c('td',[_v("user with a high volume of applicants")]),_v(" "),_c('td',[_v("batch update applicants stage in one action")]),_v(" "),_c('td',[_v("manage and progress multiple contacts efficiently without repetitive tasks")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* *")])]),_v(" "),_c('td',[_v("user")]),_v(" "),_c('td',[_v("change any detail of a contact")]),_v(" "),_c('td',[_v("update the contact details when needed")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* *")])]),_v(" "),_c('td',[_v("newbie user")]),_v(" "),_c('td',[_v("get help on how to start using the program")]),_v(" "),_c('td',[_v("familiarize myself with how to use the program")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* *")])]),_v(" "),_c('td',[_v("senior user")]),_v(" "),_c('td',[_v("know proportion of contacts who pass/fail in different recruitment stages")]),_v(" "),_c('td',[_v("get insightful data to help me adjust how much more/less to accept in the next recruitment period")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("* *")])]),_v(" "),_c('td',[_v("user")]),_v(" "),_c('td',[_v("filter contacts with fuzzy match")]),_v(" "),_c('td',[_v("find relevant contacts easily without typing the exact keywords")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("*")])]),_v(" "),_c('td',[_v("user")]),_v(" "),_c('td',[_v("highlight contact of applicant with criminal record or conflicts of interest")]),_v(" "),_c('td',[_v("easily locate applicants who needs to be investigated further")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("*")])]),_v(" "),_c('td',[_v("organized user")]),_v(" "),_c('td',[_v("view visual timeline of each contact's recruitment stage")]),_v(" "),_c('td',[_v("easily keep track of the position of each contact in the recruitment process")])]),_v(" "),_c('tr',[_c('td',[_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("*")])]),_v(" "),_c('td',[_v("user")]),_v(" "),_c('td',[_v("store applicant's resume")]),_v(" "),_c('td',[_v("easily access and refer to their resume")])])])])])}
},function anonymous(
) {
...
with(this){return _c('p',[_v("(For all use cases below, the "),_c('strong',[_v("System")]),_v(" is the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("System")]),_v(" and the "),_c('strong',[_v("Actor")]),_v(" is the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("User")]),_v(", unless specified otherwise.)")])}
},function anonymous(
) {
with(this){return _c('h4',{attrs:{"id":"uc001-add-a-contact"}},[_c('strong',[_v("UC001: Add a contact")]),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#uc001-add-a-contact","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("MSS")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_c('p',[_v("User requests to add a new contact by providing a name, phone number, email, job code, tag, and optional remark.")])]),_v(" "),_c('li',[_c('p',[_v("System validates the provided input.")])]),_v(" "),_c('li',[_c('p',[_v("System checks if the contact already exists by verifying the uniqueness of the phone number and email.")])]),_v(" "),_c('li',[_c('p',[_v("System adds the contact to the system and displays a confirmation message.")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('p',[_v("2a. The provided input is invalid (e.g., invalid phone number format, name too long).")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("2a1. System shows an error message and prompts the user to correct the input.")]),_v(" "),_c('p',[_v("Use case ends.")])])])]),_v(" "),_c('li',[_c('p',[_v("3a. A duplicate contact is found (same phone number or email).")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("3a1. System displays a duplicate contact error message.")]),_v(" "),_c('p',[_v("Use case ends.")])])])])])}
},function anonymous(
) {
with(this){return _c('h4',{attrs:{"id":"uc002-delete-a-contact"}},[_c('strong',[_v("UC002: Delete a contact")]),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#uc002-delete-a-contact","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("MSS")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_c('p',[_v("User requests to delete a specific contact by providing a valid identifier, which can be one of the following:"),_c('br'),_v("\nIndex (positive integer), Name (n/NAME), Email (e/EMAIL), Phone (p/PHONE).")])]),_v(" "),_c('li',[_c('p',[_v("System validates the provided input:\nChecks if the identifier matches the valid format (e.g., positive integer, name, email, or phone).")])]),_v(" "),_c('li',[_c('p',[_v("System checks if the contact exists (using the provided identifier, which could be a name, email, or phone number).")])]),_v(" "),_c('li',[_c('p',[_v("System deletes the contact and displays a confirmation message.")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('p',[_v("2a. The provided input is invalid (e.g., invalid phone number format, name too long, invalid command format).")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("2a1. System shows an error message indicating invalid command format or invalid parameter and prompts the user to correct the input.")]),_v(" "),_c('p',[_v("Use case ends.")])])])]),_v(" "),_c('li',[_c('p',[_v("3a. No contact matches the provided identifier.")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("3a1. System shows an error message stating that no contact matches the provided identifier and prompts the user to correct the input.")]),_v(" "),_c('p',[_v("Use case ends.")])])])]),_v(" "),_c('li',[_c('p',[_v("3b. Multiple contacts with the same name are found, and the user has not provided a phone number or email.")]),_v(" "),_c('ul',[_c('li',[_v("3b1. System asks the user to provide other details (phone number or email) to specify the contact to delete."),_c('br'),_v("\nUse case ends.")])])])])}
},function anonymous(
) {
with(this){return _c('h4',{attrs:{"id":"uc003-list-all-contacts"}},[_c('strong',[_v("UC003: List all contacts")]),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#uc003-list-all-contacts","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("MSS")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_c('p',[_v("User requests to list all contacts.")])]),_v(" "),_c('li',[_c('p',[_v("System retrieves all stored contacts from the system.")])]),_v(" "),_c('li',[_c('p',[_v("System displays the list of contacts.")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('h4',{attrs:{"id":"uc004-find-contacts"}},[_c('strong',[_v("UC004: Find contacts")]),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#uc004-find-contacts","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("MSS")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_c('p',[_v("User requests to find contacts by name, phone number, email, job code, tag, remark or a combination of some of them.")])]),_v(" "),_c('li',[_c('p',[_v("System validates the find criteria.")])]),_v(" "),_c('li',[_c('p',[_v("System retrieves and displays the contacts matching the criteria.")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('p',[_v("2a. The find criteria are invalid (e.g., tag not recognized).")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("2a1. System shows an error message.")]),_v(" "),_c('p',[_v("Use case ends.")])])])])])}
},function anonymous(
) {
with(this){return _c('h4',{attrs:{"id":"uc005-viewing-help"}},[_c('strong',[_v("UC005: Viewing Help")]),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#uc005-viewing-help","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("MSS")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_c('p',[_v("User requests help to use the system.")])]),_v(" "),_c('li',[_c('p',[_v("System displays a link to website containing more information (user guide).")])]),_v(" "),_c('li',[_c('p',[_v("User goes to the provided link to see more information.")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('h4',{attrs:{"id":"uc006-showing-applicant-statistics"}},[_c('strong',[_v("UC006: Showing Applicant Statistics")]),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#uc006-showing-applicant-statistics","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("MSS")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_c('p',[_v("User requests to view applicant statistics.")])]),_v(" "),_c('li',[_c('p',[_v("System retrieves statistics data (e.g., counts of applicants by job code and tags).")])]),_v(" "),_c('li',[_c('p',[_v("System displays the statistics in a summary view.")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('h4',{attrs:{"id":"uc007-bulk-rejecting-contacts"}},[_c('strong',[_v("UC007: Bulk Rejecting Contacts")]),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#uc007-bulk-rejecting-contacts","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("MSS")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_c('p',[_v("User requests to bulk reject contacts by providing a job code, tag, or both.")])]),_v(" "),_c('li',[_c('p',[_v("System validates the input and checks if any contacts match the criteria.")])]),_v(" "),_c('li',[_c('p',[_v("System updates the matching contacts' tags to "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("r")]),_v(" (rejected) and displays a confirmation message.")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('p',[_v("2a. The criteria are invalid (e.g., tag not recognized).")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("2a1. System shows an error message.")]),_v(" "),_c('p',[_v("Use case ends.")])])])])])}
},function anonymous(
) {
with(this){return _c('h4',{attrs:{"id":"uc008-sorting-contacts"}},[_c('strong',[_v("UC008: Sorting Contacts")]),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#uc008-sorting-contacts","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("MSS")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_c('p',[_v("User requests to sort contacts by specifying zero or more sorting criteria (e.g., name, phone, email, job code, tag).")])]),_v(" "),_c('li',[_c('p',[_v("System validates the sorting criteria.")])]),_v(" "),_c('li',[_c('p',[_v("System sorts the contacts based on the specified criteria in the given order.")])]),_v(" "),_c('li',[_c('p',[_v("System displays the sorted list of contacts.")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('p',[_v("2a. The sorting criteria are invalid (e.g., unsupported field for sorting).")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("2a1. System shows an error message indicating invalid sorting criteria.")]),_v(" "),_c('p',[_v("Use case ends.")])])])])])}
},function anonymous(
) {
with(this){return _c('h4',{attrs:{"id":"uc009-clearing-all-contacts"}},[_c('strong',[_v("UC009: Clearing All Contacts")]),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#uc009-clearing-all-contacts","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("MSS")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_c('p',[_v("User requests to clear all contacts from the address book.")])]),_v(" "),_c('li',[_c('p',[_v("System deletes all contacts and displays a confirmation message.")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('h4',{attrs:{"id":"uc010-exiting-the-program"}},[_c('strong',[_v("UC010: Exiting the Program")]),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#uc010-exiting-the-program","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("MSS")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_c('p',[_v("User requests to exit the program.")])]),_v(" "),_c('li',[_c('p',[_v("System terminates and closes the application.")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('h4',{attrs:{"id":"uc011-edit-a-contact"}},[_c('strong',[_v("UC011: Edit a contact")]),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#uc011-edit-a-contact","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("MSS")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_c('p',[_v("User requests to edit a specific contact by providing an index and one or more fields to update (name, phone number, email, job code, tag).")])]),_v(" "),_c('li',[_c('p',[_v("System validates the provided input.")])]),_v(" "),_c('li',[_c('p',[_v("System checks if the contact exists at the specified index.")])]),_v(" "),_c('li',[_c('p',[_v("System checks if the edited details causes duplicate.")])]),_v(" "),_c('li',[_c('p',[_v("System updates the contact’s details with the provided information and displays a confirmation message.")]),_v(" "),_c('p',[_v("Use case ends.")])])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions")])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('p',[_v("2a. The provided input is invalid (e.g. invalid phone number format).")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("2a1. System shows an error message indicating invalid input and prompts the user to correct it.")]),_v(" "),_c('p',[_v("Use case ends.")])])])]),_v(" "),_c('li',[_c('p',[_v("3a. No contact is found at the specified index.")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("3a1. System shows an error message indicating that no contact exists at the specified index.")]),_v(" "),_c('p',[_v("Use case ends.")])])])]),_v(" "),_c('li',[_c('p',[_v("4a. The edited details causes duplicate contacts.")]),_v(" "),_c('ul',[_c('li',[_c('p',[_v("4a1. System shows an error message indicating that the contact already exists.")]),_v(" "),_c('p',[_v("Use case ends.")])])])])])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_v("The system should work seamlessly across macOS, Windows, and Linux operating systems.")]),_v(" "),_c('li',[_v("The system should support both 32-bit and 64-bit environments.")]),_v(" "),_c('li',[_v("Should work on any mainstream OS as long as it has Java "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("17")]),_v(" or above installed.")]),_v(" "),_c('li',[_v("The system should execute commands (such as adding, deleting, or listing contacts) within 1 second under normal loads (e.g., up to 1,000 contacts).")]),_v(" "),_c('li',[_v("Should be able to hold up to 1,000 persons without noticeable sluggishness in performance for typical usage.")]),_v(" "),_c('li',[_v("A user with above-average typing speed for regular English text (i.e., not code, not system admin commands) should be able to accomplish most of the tasks faster using commands than using the mouse.")]),_v(" "),_c('li',[_v("The system must be user-friendly and usable by individuals with no prior experience with contact management systems.")]),_v(" "),_c('li',[_v("Volatility: Transaction data should be stored persistently and remain available for a minimum of 10 years.")]),_v(" "),_c('li',[_v("Complete user documentation, including installation and setup instructions, must be provided.")]),_v(" "),_c('li',[_v("The system should be designed to allow for the addition of new modules without requiring a full redesign.")]),_v(" "),_c('li',[_v("The system should gracefully handle incorrect or incomplete inputs by providing meaningful error messages without crashing.")])])}
},function anonymous(
) {
...
with(this){return _c('ul',[_c('li',[_c('strong',[_v("Applicant")]),_v(": An individual who has submitted job application to the company.")]),_v(" "),_c('li',[_c('strong',[_v("Job Code")]),_v(" : A code that represents the company's specific job role.")]),_v(" "),_c('li',[_c('strong',[_v("Tag")]),_v(" : Interview stages that applicants will go through for a job before they could get hired. The following are the default tags and abbreviations in the address book:")])])}
},function anonymous(
) {
with(this){return _c('div',{staticClass:"table-responsive"},[_c('table',{staticClass:"markbind-table table table-bordered table-striped"},[_c('thead',[_c('tr',[_c('th',[_v("Tag")]),_v(" "),_c('th',[_v("Interview Stage")]),_v(" "),_c('th',[_v("Definition")])])]),_v(" "),_c('tbody',[_c('tr',[_c('td',[_v("N")]),_v(" "),_c('td',[_v("New")]),_v(" "),_c('td',[_v("New applicant")])]),_v(" "),_c('tr',[_c('td',[_v("TP")]),_v(" "),_c('td',[_v("Technical Interview in Progress")]),_v(" "),_c('td',[_v("Technical interview is in the process of being scheduled for the applicant")])]),_v(" "),_c('tr',[_c('td',[_v("TC")]),_v(" "),_c('td',[_v("Technical Interview Confirmed")]),_v(" "),_c('td',[_v("Technical interview has been schedule for the applicant")])]),_v(" "),_c('tr',[_c('td',[_v("BP")]),_v(" "),_c('td',[_v("Behavioral Interview in Progress")]),_v(" "),_c('td',[_v("Behavioral interview is in the process of being scheduled for the applicant")])]),_v(" "),_c('tr',[_c('td',[_v("BC")]),_v(" "),_c('td',[_v("Behavioral Interview Confirmed")]),_v(" "),_c('td',[_v("Behavioral interview has been scheduled for the applicant")])]),_v(" "),_c('tr',[_c('td',[_v("A")]),_v(" "),_c('td',[_v("Accepted")]),_v(" "),_c('td',[_v("Applicant has been accepted by the company")])]),_v(" "),_c('tr',[_c('td',[_v("R")]),_v(" "),_c('td',[_v("Rejected")]),_v(" "),_c('td',[_v("Applicant has been rejected by the company")])])])])])}
},function anonymous(
) {
with(this){return _c('ul',[_c('li',[_c('strong',[_v("Person")]),_v(": A single entry in Talency address book that contains information about a particular applicant such as name, phone number, email address, and any other relevant details.")]),_v(" "),_c('li',[_c('strong',[_v("Command")]),_v(": A specific text-based instruction given by the user to the system to perform a particular action (e.g., add NAME p/PHONE e/EMAIL j/JOB_CODE t/TAG is a command to add a contact to the address book).")])])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_c('p',[_v("Initial launch")]),_v(" "),_c('ol',[_c('li',[_c('p',[_v("Download the jar file and copy into an empty folder")])]),_v(" "),_c('li',[_c('p',[_v("Open a command terminal, "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("cd")]),_v(" into the folder you put the jar file in, and use the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("java -jar Talentcy.jar")]),_v(" command to run the application. "),_c('br'),_v("\nExpected: Shows the GUI with a set of sample contacts. The window size may not be optimum.")])])])]),_v(" "),_c('li',[_c('p',[_v("Saving window preferences")]),_v(" "),_c('ol',[_c('li',[_c('p',[_v("Resize the window to an optimum size. Move the window to a different location. Close the window.")])]),_v(" "),_c('li',[_c('p',[_v("Re-launch the app by opening command terminal in the folder containing the jar file, then use "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("java -jar Talentcy.jar")]),_v("."),_c('br'),_v("\nExpected: The most recent window size and location is retained.")])])])])])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_v("Adding a Person\n"),_c('ol',[_c('li',[_v("Test case: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("add n/John Doe p/98765432 e/johnd@example.com j/SWE123 t/N r/Good skills")]),_c('br'),_v("\nExpected: Assuming no duplicates, a new contact named John Doe is added to the list. The status message displays details of the added contact.")]),_v(" "),_c('li',[_v("Test case: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("add n/ p/ e/ j/ t/")]),_c('br'),_v("\nExpected: No person is added. An error message displays in the status, indicating missing fields.")]),_v(" "),_c('li',[_v("Other incorrect add commands to try: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("add n/John")]),_v(", "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("add p/98765432")]),_v(", "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("add e/notemail")]),_v(", "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("add t/Went to NUS")]),_c('br'),_v("\nExpected: Error messages display for each incomplete command, and no contact is added.")])])])])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_c('p',[_v("Deleting a person while all persons are being shown")]),_v(" "),_c('ol',[_c('li',[_c('p',[_v("Prerequisites: List all persons using the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("list")]),_v(" command. At least one person in the list.")])]),_v(" "),_c('li',[_c('p',[_v("Test case: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("delete 1")]),_c('br'),_v("\nExpected: First person is deleted from the list. Details of the deleted person is shown in the status message.")])]),_v(" "),_c('li',[_c('p',[_v("Test case: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("delete 0")]),_c('br'),_v("\nExpected: No person is deleted. Error details shown in the status message. Status bar remains the same.")])]),_v(" "),_c('li',[_c('p',[_v("Other incorrect delete commands to try: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("delete")]),_v(", "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("delete x")]),_v(" (where x is larger than the list size)"),_c('br'),_v("\nExpected: Error messages displayed, and no person is deleted.")])])])]),_v(" "),_c('li',[_c('p',[_v("Deleting a person based on its attribute")]),_v(" "),_c('ol',[_c('li',[_c('p',[_v("Prerequisites: At least one person stored in the app.")])]),_v(" "),_c('li',[_c('p',[_v("Test case: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("delete n/John Doe")]),_v("\nExpected: Assuming there are only one person with the name "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("John Doe")]),_v(" in the list, that person will be deleted from the list. Details of the deleted person is shown in status message.")])]),_v(" "),_c('li',[_c('p',[_v("Test case: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("delete p/80981234")]),_v("\nExpected: Assuming a person with phone number 80981234 exists in the list, that person will be deleted. Details of the deleted person is shown in status message.")])]),_v(" "),_c('li',[_c('p',[_v("Test case: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("delete e/pu09com")]),_v("\nExpected: No person is deleted. Error message is shown in the status bar.")])]),_v(" "),_c('li',[_c('p',[_v("Other incorrect delete commands to try: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("delete John Doe")]),_v(", "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("delete p/x")]),_v(" (where a person with phone number x doesn't exist in the list).\nExpected: No person is deleted. Error message is shown in the status bar.")])])])])])}
},function anonymous(
) {
with(this){return _c('h3',{attrs:{"id":"finding-persons-by-criteria"}},[_v("Finding Persons by Criteria"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#finding-persons-by-criteria","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_v("Finding Persons with Specific Criteria\n"),_c('ol',[_c('li',[_v("Prerequisites: Ensure there are persons with various entry of fields.")]),_v(" "),_c('li',[_v("Test case:"),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("find n/John")]),_c('br'),_v("\nExpected: Displays a list of person(s) with \"John\" in their names, case-insensitive. Empty list will be displayed if a person with that specific criteria(s) is not found.")]),_v(" "),_c('li',[_v("Test case: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("find t/TP n/Jane")]),_c('br'),_v("\nExpected: Shows a list of person(s) with \"Jane\" in their name and tagged as "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Technical Interview in Progress")]),_v(". Empty list will be displayed if a person with that specific criteria(s) is not found.")]),_v(" "),_c('li',[_v("Incorrect add commands to try: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("find")]),_v(", "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("find John")]),_v(", "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("find p/notphone")]),_c('br'),_v("\nExpected: Error message is shown in the status bar. List of persons shown will remain the same.")])])])])}
},function anonymous(
) {
with(this){return _c('h3',{attrs:{"id":"sorting-persons-by-fields"}},[_v("Sorting Persons by Fields"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#sorting-persons-by-fields","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_v("Sorting by Fields\n"),_c('ol',[_c('li',[_v("Prerequisites: Ensure there are multiple persons with various entry of fields.")]),_v(" "),_c('li',[_v("Test case: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("sort n/")]),_c('br'),_v("\nExpected: Sorts the persons alphabetically by name.")]),_v(" "),_c('li',[_v("Test case: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("sort t/ j/")]),_c('br'),_v("\nExpected: Sorts first by tag, then by job code within each tag group.")]),_v(" "),_c('li',[_v("Test case: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("sort j/ n/")]),_c('br'),_v("\nExpected: Sorts first by job code, then by name within each job code group.")])])])])}
},function anonymous(
) {
with(this){return _c('h4',{attrs:{"id":"bulk-rejecting-by-criteria"}},[_v("Bulk Rejecting by Criteria"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#bulk-rejecting-by-criteria","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_v("Bulk Rejecting Contacts\n"),_c('ol',[_c('li',[_v("Prerequisites: Ensure there are persons with various job codes and tags, including the "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Accepted")]),_v(" tag.")]),_v(" "),_c('li',[_v("Test case: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("massreject j/SWE2024 t/TP")]),_c('br'),_v("\nExpected: Marks all persons with job code "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("SWE2024")]),_v(" and tag "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("TP")]),_v(" (if any) as rejected, displaying a confirmation status.")]),_v(" "),_c('li',[_v("Test case: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("massreject j/AWE2023")]),_c('br'),_v("\nExpected: Marks all persons with job code "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("AWE2023")]),_v(" as rejected, except for the person(s) that has an "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("Accepted")]),_v(" tag.`.")])])])])}
},function anonymous(
) {
with(this){return _c('h4',{attrs:{"id":"viewing-applicant-statistics"}},[_v("Viewing Applicant Statistics"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#viewing-applicant-statistics","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_v("Viewing Statistics\n"),_c('ol',[_c('li',[_v("Prerequisites: Ensure there are multiple persons with diverse tags and job codes.")]),_v(" "),_c('li',[_v("Test case: "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("stats")]),_c('br'),_v("\nExpected: Displays the total number of applicants, the percentage of applicants in each interview stage, and the breakdown of applicants by job code.")])])])])}
},function anonymous(
) {
with(this){return _c('h4',{attrs:{"id":"saving-data-with-missing-corrupted-files"}},[_v("Saving Data with Missing/Corrupted Files"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#saving-data-with-missing-corrupted-files","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_v("Handling Missing or Corrupted Data Files**\n"),_c('ol',[_c('li',[_c('p',[_v("Prerequisites: Ensure "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("talentcy.json")]),_v(" has multiple entries, and back up the file before testing.")])]),_v(" "),_c('li',[_c('p',[_v("Test Case: Invalid Data Format\nSimulation: Edit one field from a person entry in the JSON file (e.g. change the phone field to non-numeric), then launch the app.\nExpected: The app discards "),_c('strong',[_v("all")]),_v(" data and starts with an empty list.")])]),_v(" "),_c('li',[_c('p',[_v("Test Case: Missing "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("talentcy.json")]),_v(" File\nSimulation: Delete "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("talentcy.json")]),_v(", then launch the app.\nExpected: The app creates a new "),_c('code',{pre:true,attrs:{"class":"hljs inline no-lang"}},[_v("talentcy.json")]),_v(", the app starts on clean slate (i.e. with sample data only).")])])])])])}
},function anonymous(
) {
with(this){return _c('footer',[_c('div',{staticClass:"text-center"},[_c('small',[_v("["),_c('span',[_c('strong',[_v("Powered by")])]),_v(" "),_c('img',{attrs:{"src":"https://markbind.org/favicon.ico","width":"30"}}),_v(" "),_c('a',{attrs:{"href":"https://markbind.org/"}},[_v("MarkBind 5.5.3")]),_v(", generated on Tue, 12 Nov 2024, 11:38:49 GMT+8]")])])])}
}];
